                        ...
                        postData && postData.map((e,i)=>{
                            ...
                            return(
                                <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                        <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xs sm:text-sm py-2.5">{e.username}</li>
                                        <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xs sm:text-sm py-2.5">{e.title}</li>
                                        <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xs sm:text-sm py-2.5">{formateDate}</li>
                                </ul>
                            )
                            })
                    }
